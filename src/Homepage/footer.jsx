...
const Footer = ()=>{
    return(
        <div className="w-full bg-blue-600 px-4 pt-16">
      ...
      <div className="sm:col-span-2">
        ...
        <div className="mt-6 lg:max-w-sm">
          <p className="text-sm text-gray-800">
            Kami adalah perusahaan yang berfokus pada solusi teknologi kreatif untuk masa depan yang lebih baik.
          </p>
          <p className="mt-4 text-sm text-gray-800">
            Visi kami adalah menjadi pelopor dalam inovasi digital, membawa dampak positif ke seluruh dunia.
          </p>
        </div>
      </div>
